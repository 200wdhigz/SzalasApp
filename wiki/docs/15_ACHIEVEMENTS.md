...
- Tylko Administrator:
  ...
  - ręcznie przyznaje/odbiera odznaki użytkownikom.
...
- Nowe typy zdarzeń
  - Aktualnie obsługiwane są: `report_created`, `loan_created`, `speedy_return`, `help_resolve`.
...
- Upewnij się, że testowy użytkownik ma włączoną funkcję Osiągnięcia.
